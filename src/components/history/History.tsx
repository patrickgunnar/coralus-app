...
class HistoryContent extends Component<HistoryContentProps> {
    render(): ReactNode {
        ...
        return (
            <div className="box-border hidden md:flex flex-col justify-between items-center text-center text-gray-200 h-full w-[40%]">
                ...
                <div className="box-border flex gap-2 flex-col justify-start items-center p-6 h-[85%] w-full overflow-hidden overflow-y-auto">
